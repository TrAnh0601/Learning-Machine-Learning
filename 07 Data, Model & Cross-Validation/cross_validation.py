...
def cross_val_score(estimator, X, y, cv=5, scoring=None, fit_params=None, random_state=None):
    ...
    for train_idx, val_idx in splitter.split(X, y):
        ...
        if scoring is not None:
            score = scoring(fold_est, X_val, y_val)
        else:
            score = fold_est.score(X_val, y_val)
...
class GridSearchCV:
    def __init__(self, estimator, param_grid, cv=5, scoring=None, fit_params=None, random_state=None):
